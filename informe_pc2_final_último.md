...
![Calificación promedio: pedidos a tiempo vs. retrasados](figures/fig_01_entrega_vs_calificacion.png)
...
![Calificación promedio según proporción del envío](figures/fig_02_freight_ratio_vs_calificacion.png)
...
![Freight ratio según baja satisfacción](figures/fig_05_freight_ratio_baja_satisfaccion.png)
...
![Categorías con menor calificación promedio](figures/fig_03_categorias_menor_calificacion.png)
...
![Matriz de correlación de variables clave](figures/fig_04_matriz_correlacion.png)
...
![Porcentaje de baja satisfacción por cluster](figures/fig_06_clusters_baja_satisfaccion.png)
...
## 14. Elementos por completar antes de publicar

- [ ] Reemplazar los tres links del inicio: notebook, dashboard y repositorio.
- [ ] Cuando el notebook integre y ejecute la fuente externa de feriados/calendario, actualizar la sección 3.5 con el nombre de la fuente, cómo se unió a Olist y un resultado verificable.
- [ ] Verificar que las imágenes se visualicen correctamente en GitHub.
